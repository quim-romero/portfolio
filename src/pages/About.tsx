      ...
      <main id="main" role="main" aria-label="About page content">
        ...
        >
          ...
          <p className="text-muted mb-6 leading-relaxed text-lg">
            ...
            degree in web development. My strengths lie in blending clean
            design, logical structure, and smooth animation.
          </p>

          <p className="text-muted mb-6 leading-relaxed text-lg">
            I’ve built full interface simulations — from dashboards to
            microsites — all crafted with performance and personality in mind. I
            move fast, write scalable code, and care about the little things.
          </p>

          <section aria-labelledby="how-heading">
            <h2 id="how-heading" className="text-2xl font-semibold mb-4 mt-10">
              How I Work
            </h2>
            <ul className="list-disc list-inside text-muted space-y-3">
              ...
              <li>
                Detail-obsessed: from spacing to keyboard UX to
                microinteractions.
              </li>
              <li>
              ...
              <li>
                User experience is a priority — the interface should feel as
                good as it looks.
              </li>
            </ul>
          </section>
          ...
          <section aria-labelledby="tools-heading" className="mt-12">
            <h2 id="tools-heading" className="text-2xl font-semibold mb-4">
              Tools & Technologies
            </h2>
